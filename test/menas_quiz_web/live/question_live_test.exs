defmodule MenasQuizWeb.QuestionLiveTest do
  use MenasQuizWeb.ConnCase

  import Phoenix.LiveViewTest
  import MenasQuiz.QuizFixtures

  @create_attrs %{question: "some question", answers: "some answers", solution_id: "some solution_id"}
